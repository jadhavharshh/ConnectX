...
import { BookOpen, Users, FileText, Bell, Brain, Shield } from 'lucide-react'
            ...
            <div className="mx-auto max-w-5xl px-6">
                <div className="relative">
                    <div className="text-center pb-10">
                        <h2 className="text-balance text-4xl font-semibold lg:text-5xl">Built for modern education</h2>
                        <p className="mt-4">A comprehensive learning management system designed to connect students and mentors seamlessly.</p>
                    </div>
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <h2 className="mt-6 text-center text-3xl font-semibold">Responsive</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                    <FileText className="m-auto h-fit w-16" />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="group-hover:text-secondary-950 text-lg font-medium transition dark:text-white">Document Management</h2>
                                    <p className="text-foreground">Secure document uploading, storage, and approval workflow for student submissions with progress tracking and status updates.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    ...
                                    <p className="text-foreground">Create and assign tasks with deadlines, priorities, and point values. Track progress and submission status for each student.</p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition dark:text-white">Announcements</h2>
                                        <p className="text-foreground">Broadcast important updates to students with categorized announcements. Highlight critical information with priority settings.</p>
                                    </div>
                                </div>
                        ...
                        <Card className="card variant-outlined relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition">Mentor-Mentee System</h2>
                                        <p className="text-foreground">Seamlessly connect mentors with students. Enable document approvals, progress tracking, and guided learning experiences.</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Mentor</span>
                                            <div className="ring-background size-7 ring-4">
                                                <BookOpen className="size-full rounded-full p-1" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 ring-4">
                                                <Brain className="size-full rounded-full p-1" />
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">AI Assistant</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Student</span>
                                            <div className="ring-background size-7 ring-4">
                                                <Users className="size-full rounded-full p-1" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
